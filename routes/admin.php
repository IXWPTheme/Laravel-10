...
use App\Http\Controllers\Admin\SiteFindingController;
...
Route::prefix('admin')->name('admin.')->group(function(){
    ...
    Route::middleware(['auth:admin','PreventBackHistory'])->group(function(){
        ...
        //SITEFINDING AND UNITS MANAGEMENT SYSTEM
        Route::prefix('manage-site-finding')->name('manage-site-finding.')->group(function(){
           Route::controller(SiteFindingController::class)->group(function(){
               Route::get('/','siteFindingList')->name('site-finding-list');
               Route::get('/add-sites','addSites')->name('add-sites');
               Route::post('/store-sites','storeSites')->name('store-sites');
               Route::get('/edit-category','editCategory')->name('edit-category');
               Route::post('/update-category','updateCategory')->name('update-category');
               Route::get('/add-units','addUnitsSites')->name('add-units');
               Route::post('/store-unit','storeUnits')->name('store-unit');
               Route::get('/add-finding','addFinding')->name('add-finding');
               Route::post('/store-finding','storeFinding')->name('store-finding');
